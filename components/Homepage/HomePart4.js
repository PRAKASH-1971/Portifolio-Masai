...
const HomePart4 = () => {
  ...
  function mailClick() {
    setCopyText("prakashdsouza077@gmail.com");
    setPopup("block");
    setText("Text Copied");
    setTimeout(() => {
      setPopup("none");
    ...
    <div className="h4-container">
      <div className="contents">
        ...
        <div className="box">
          ...
          >
            <span onClick={() => mailClick()}>prakashdsouza077@gmail.com</span>
            </OverlayTrigger>
          </div>
          ...
          <div className="card">
            ...
            overlay={<Tooltip id="tooltip-disabled">{text}</Tooltip>}
          >
            <span onClick={() => callClick()}>+916360243612</span>
            </OverlayTrigger>
          </div>
